...
class ShareImporter {
	 ...
	 * @param Share[] $shareModels the share models to be imported
	 ...
	 */
	public function import(string $userId, array $shareModels, string $targetRemoteHost) {
		$currentHostUrl = \rtrim($this->urlGenerator->getAbsoluteURL('/'), '/');
		foreach ($shareModels as $shareModel) {
